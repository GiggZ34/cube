...
/*   Updated: 2021/03/11 23:59:48 by grivalan         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (!(game->sky_ground.sky_texture.ptr = mlx_xpm_file_to_image(game->mlx,
												"./textures/sky.xpm",
												&(game->sky_ground.sky_texture.width),
												&(game->sky_ground.sky_texture.height))))
		return (3);
	if (!(game->sky_ground.sky_texture.color = (int*)mlx_get_data_addr(game->sky_ground.sky_texture.ptr,
