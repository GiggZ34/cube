...
/*   Updated: 2021/03/18 13:24:15 by grivalan         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_scan_horizontal_left(t_game *game, char **map, int i, int j)
{
	...
	if (map[i][j] == '1')
	{
		pos[0] = j + 1;
		pos[1] = i;
		game->file.error_code = ft_create_plane(game,
											&game->lst_planes_left, pos, 'L');
	}
