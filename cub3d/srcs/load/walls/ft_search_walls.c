...
/*   Updated: 2021/02/02 12:55:26 by grivalan         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
static t_dot	ft_corner_border_right(char **map, t_player *player)
{
	int		angle;
...
static t_dot	ft_corner_border_left(char **map, t_player *player)
{
	int		angle;
...
static void		ft_scan_angle_view(t_game *game, char **map, t_player *player)
{
	int		angle;
...
int				ft_search_walls(t_game *game)
{
	...
	min = ft_corner_border_left(map, game->player);
	max = ft_corner_border_right(map, game->player);
	...
	ft_scan_angle_view(game, map, game->player);
	ft_free_array(map);
	return (0);
}
